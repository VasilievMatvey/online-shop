...
//список 3х последних товаров
router.get("/getlast", ProductController.getLastThreeProducts);
...
router.post(
  "/create",
  /*authMiddleware, adminMiddleware,*/ ProductController.create
);
// обновить товар каталога  — нужны права администратора
router.put(
  "/update/:id([0-9]+)",
  /*authMiddleware, adminMiddleware,*/ ProductController.update
);
// удалить товар каталога  — нужны права администратора
router.delete(
  "/delete/:id([0-9]+)",
  /*authMiddleware, adminMiddleware,*/ ProductController.delete
);
